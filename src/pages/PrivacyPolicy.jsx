      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          <div className="w-full">
            <h3 className="text-2xl md:text-5xl  text-center pb-10 font-medium">YouSave’s Privacy Policy</h3>
          </div>

          <div className="w-full md:w-1/3 p-8">
            <div className="text-justify">
              <p className="mb-5">
                Your privacy is extremely important to us. To better protect you, we provide this
                notice explaining our online information practices and the choices you can make
                about the way your information is collected and used. This Privacy Policy relates to
                information collected by YouSave (referred to in this Privacy Policy as "YouSave"
                "we" or "us" or "our") through your use of our website and our Services, features,
                and information available on our website (which are collectively referred to in this
                Privacy Policy as the "YouSave Service").
              </p>
              <p>
                If you do not agree to our use of your personal data in line with this policy,
                please do not use the YouSave Services.
              </p>
            </div>
            ...
            <div className="mt-6">
              {[
                ...
                <div key={index} className="mb-4">
                  <a href={`#${index + 1}`} className="block text-lg font-bold text-red-600">
                    {index + 1}. {item}
                  </a>
                  <div className={`h-1 ${index === 0 ? 'bg-red-500' : 'bg-gray-300'}`}></div>
                </div>
              ))}
            </div>
          ...
          <div className="w-full md:w-2/3 p-8">
            <div className="hidden md:block text-justify">
              <p className="mb-4">
                Your privacy is extremely important to us. To better protect you, we provide this
                notice explaining our online information practices and the choices you can make
                about the way your information is collected and used. This Privacy Policy relates
                to information collected by YouSave (referred to in this Privacy Policy as
                "YouSave" "we" or "us" or "our") through your use of our website and our Services,
                features, and information available on our website (which are collectively
            ...
            <div className="text-justify">
              ...
              <div className="mb-6">
                <b>
                  By using the YouSave Service, you signify your acceptance of this Privacy Policy.
                  If you do not agree to this Privacy Policy, you should not use the YouSave Service.
                  Continued use of the YouSave Service following the posting of changes to this
                  Privacy Policy that do not significantly affect the use or disclosure of your
                  personally identifiable information will mean that you accept those changes.
                </b>
              </div>
            </div>
          </div>
