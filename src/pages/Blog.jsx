      ...
      <section className="pb-2">
        <div className="container mx-auto w-full md:w-5/5 lg:w-4/5">
          ...
          <div
            ...
            style={{ backgroundImage: "url('https://yousave.ai/img/cyber-security-banner%202.png')" }}
          >
            <div className="pt-10">
            ...
            <div className="blog-text pt-10">
              <div className="blog-title w-full md:w-2/3 lg:w-1/2 pl-4 text-white text-xl md:text-2xl font-poppins font-medium">
                <p>YouSave’s next Generation <br /> Security technology</p>
              </div>
            </div>
            <div className="read-text pt-10">
              <div className="read-more w-3/4 md:w-2/3 lg:w-2/5 pl-4 text-white text-sm md:text-xs font-poppins font-medium underline">
                <a href="blogs/security-technlogy.html" className="hover:text-lime-400">Read Now</a>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                title: "Revolutionize Your Digital Art: the Apple Pencil Pro is Every Artist's Dream Tool",
                date: "19th April, 2024"
              },
              {
                link: "blogs/The-iPad-10th-Generation.html",
                img: "https://yousave.ai/img/images-4 1.png",
                title: "The iPad 10th Generation: YouSave’s Technology Unveils the Ultimate Powerhouse.",
                date: "19th April, 2024"
              },
              {
                link: "blogs/Mastering-the-Art-of-Savvy-Shopping.html",
                img: "https://yousave.ai/img/Vector (2).png",
                title: "Mastering the Art of Savvy Shopping: Tips and Tricks for Effective Price Comparison",
                date: "19th April, 2024"
              },
              {
                link: "blogs/best-price-comparison-sites.html",
                img: "https://yousave.ai/img/create-cashback-app 1.png",
                title: "Best Price Comparison Sites in the USA: Save Money on Every Purchase with YouSave.ai",
                date: "19th April, 2024"
              }
            ].map((post, index) => (
                      ...
                      <div className="absolute inset-0 bg-black  bg-opacity-50 p-4 flex flex-col justify-end">
                        ...
                        <div className="blog-category-text w-full md:w-full lg:w-2/5 bg-gradient-to-r from-lime-400 to-green-700 rounded-r-lg mt-4">
                          <p className="text-white text-xs text-center flex items-center justify-center">
                            <img src="https://yousave.ai/img/clock.png" alt="" className="mr-2" /> {post.date}
                          </p>
                        </div>
                      </div>
                    </div>
