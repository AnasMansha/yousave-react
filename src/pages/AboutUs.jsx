    ...
    <>
      ...
      <div className="container mx-auto w-full md:w-4/5 lg:w-3/5 py-4  md:py-6">
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-1/3 p-4">
              <div className="mt-10 pt-10 pb-10 bg-[#fff4ed] text-center font-poppins">
                <img className="mx-auto" src="https://yousave.ai/img/Group%20133.png" alt="" />
                <h2 className="pt-4 text-lg">Search over 2 billion products</h2>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-4">
              <div className="mt-10 pt-10 pb-10 bg-[#fff4ed] text-center font-poppins">
                <img className="mx-auto" src="https://yousave.ai/img/Group%20134.png" alt="" />
                <h2 className="pt-4 text-lg">Instantly compare prices</h2>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-4">
              <div className="mt-10 pt-10 pb-10 bg-[#fff4ed] text-center font-poppins">
                <img className="mx-auto" src="https://yousave.ai/img/Group%20135.png" alt="" />
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-7/12 p-4">
              <div className="font-poppins">
                ...
                <div className="flex items-center pb-4">
                  <img className="w-6" src="https://yousave.ai/img/icons8_ok_6%201.png" alt="" />
                  <p className="pl-2">All product information and prices are continually updated to make sure you take advantage of sudden price reductions, big sales, and hidden discounts, wherever they are!</p>
                </div>
              </div>
            </div>
            <div className="w-full md:w-5/12 p-4">
              <img className="about-us-img" src="https://yousave.ai/img/Group%2067.png" alt="" />
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-wrap py-5">
          <div className="w-full md:w-1/2 p-4">
            <img className="about-us-img" src="https://yousave.ai/img/Layer%206.png" alt="" />
          </div>
          <div className="w-full md:w-1/2 p-4 flex items-center">
            <div className="font-poppins">
              <p>With  of consumers compare prices in a slow and inefficient manner before buying, our platform utilizes powerful technology to make it super easy to find products and compare prices, so you take advantage of the best price, wherever it is.</p>
            </div>
          </div>
        </section>

        <div className="text-center font-poppins py-5 w-4/5 mx-auto">
          <p><b>Our mission</b> is to make it easy for anyone to find the best price across the web, with one click and all in one place. With YouSave, YouSave Money, and YouSave Faster.</p>
        </div>
      </div>
    </>
  );
