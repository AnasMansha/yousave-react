    ...
    <>
      ...
      <div className="container mx-auto px-0 font-poppins">
        ...
        <div className="flex flex-col md:flex-row mt-8">
          ...
          <main className="md:w-9/12 lg:w-8/12 px-4">
            <div className="p-4 border border-gray-200 lg:px-10">
              ...
              <section id="power" className="mb-8 text-[#454545]">
                <h2 className="text-2xl text-center md:text-xl md:text-start font-bold mb-4 md:mb-1 md:font-light">
                  "Answer
                </h2>
                <h2 className="text-2xl text-center md:text-xl md:text-start font-bold mb-4">
                  Here are the top 10 trending products this week based on the
                  provided context:
                </h2>
                <ol className="list-decimal pl-4 mb-1 space-y-2">
                  <a href="https://yousave.ai/product/AllNew-Kindle-Ereader-Black-6-inch-Glarefree-Touchscreen-Display-WiFi/17481504675113623171">
                    <li>
                      Kindle - 6" Glare-Free Display with Built-In Front Light
                    </li>
                  </a>

                  <a href="https://yousave.ai/product/Amazon-Kindle-Paperwhite-32GB-Signature-Edition-Black/4698106929299711198">
                    <li>Kindle Paperwhite - 8 GB</li>
                  </a>

                  <a href="https://yousave.ai/product/Amazon-Kindle-Paperwhite-32GB-Signature-Edition-Black/4698106929299711198">
                    <li>Kindle Paperwhite - 32 GB</li>
                  </a>
                  <a href="https://yousave.ai/product/Contigo-Autoseal-West-Loop-Stainless-Steel-Coffee-Travel-Mug-24-oz-Silver/5710347506560371031">
                    <li>
                      Contigo Autoseal West Loop Vacuum-Insulated Stainless
                      Steel Travel Mug
                    </li>
                  </a>
                  <a href="https://yousave.ai/product/Lilyana-Naturals-Eye-Cream-1-oz/12705102643531095780">
                    <li>LilyAna Naturals Eye Cream Moisturizer</li>
                  </a>
                  <a href="https://yousave.ai/product/Lilyana-Naturals-Retinol-Cream-for-Face-Made-in-USA-Retinol-Cream-Anti-Aging-/9516307406057637633">
                    <li>LilyAna Naturals Retinol Cream Moisturizer</li>
                  </a>
                  <a href="https://yousave.ai/product/LilyAna-Naturals-Vitamin-C-Serum-1-oz-30g/4926449677263248925">
                    <li>
                      LilyAna Naturals Vitamin C Serum with Hyaluronic Acid for
                      Face and Eyes
                    </li>
                  </a>
