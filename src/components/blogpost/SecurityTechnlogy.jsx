  ...
  return (<>
    ...
    <div className="container-fluid">
      <section
        ...
        style={{ backgroundImage: "url('https://yousave.ai/img/cyber-security-banner%201.svg')" }}
      >
          ...
          <div className="w-full md:w-8/12">
            ...
            <div className="blog-content-spaces mt-4 mb-4">
              ...
              <ul className="list-inside text-gray-500">
                <li>They give abnormally low prices, use fake links and impersonate big sites.</li>
                <li>Since they are banned on-the-go, they are usually very new (same year).</li>
                <li>They tend to give unknown/fake addresses, and have low-nonexistent reviews.</li>
              </ul>
              <br />
          ...
          <div className="w-full md:w-4/12 hidden md:block">
            <div className="contact-recent-post p-4">
              ...
              <form>
                ...
                <button type="submit" className="btn btn-primary p-2 w-full bg-blue-500 text-white rounded">
                  Submit
                </button>
              </form>
            </div>
