    ...
    <header className="mt-5 mb-5 hidden md:flex">
          <div className="w-full flex items-center  justify-between">
            <div className="w-1/4 flex justify-start">
              <a href="index.html">
                <img src="https://yousave.ai/img/new-logo.webp" alt="Logo" className="w-[200px]" />
              </a>
            </div>
                <div className="w-1/2 justify-center">
                  <form action="result.html" method="get">
                      <div className="input-group flex items-center w-full h-14 border-2 border-orange-500 rounded-full mx-auto">
                        ...
                        />
                        {/* <button type="submit" className="search-button bg-blue-600 text-white p-2 rounded-r-full">
        ...
        <header className="mt-5 mb-5 flex md:hidden">
          <div className="w-full text-center">
            <div>
              <a href="index.html">
                <img src="https://yousave.ai/img/new-logo.webp" alt="Logo" className="mx-auto" />
              </a>
            </div>
            <div className="mt-4">
              <form action="result.html" method="get">
                <div className="input-group flex">
                  ...
                  />
                  <button type="submit" className="search-button bg-blue-600 text-white p-2 rounded-r">
                    <i className="fas fa-search"></i>
                  </button>
                </div>
              </form>
