          ...
          <div className="disply-compaere xs:hidden">
            <div className="">
              <div className="flex justify-center flex-wrap">
                ...
                <div className="w-1/6 p-2">
                  <img
                    src="https://yousave.ai/img/Kohl's%201.png"
                    alt=""
                    className="w-1/2 mx-auto"
                  />
                </div>
                ...
                <div className="w-1/6 p-2">
                  <img
                    src="https://yousave.ai/img/Sears_Logo%201.png"
                    alt=""
                    className="w-1/2 mx-auto"
                  />
                </div>
                <div className="w-1/6 p-2">
                  <img
                    src="https://yousave.ai/img/images%201.png"
                    alt=""
                    className="w-1/2 mx-auto"
                  />
                </div>
            ...
            <div className="">
              <div className="flex justify-center flex-wrap">
                <div className="w-1/6 p-2">
                  <img
                    src="https://yousave.ai/img/Macys_logo%201.png"
                    alt=""
                    className="w-1/2 mx-auto"
                  />
                </div>
                ...
                <div className="w-1/6 p-2">
                  <img
                    src="https://yousave.ai/img/EBay_logo%201.png"
                    alt=""
                    className="mt-[-30%]"
                  />
                </div>
