...
const Filter = () => {
  ...
  return (
    <div className="w-full lg:w-1/5 mt-8 lg:mt-0 pt-8">
      <div id="filterOverlay" className="hidden fixed inset-0 bg-black bg-opacity-60 z-50 lg:hidden"></div>
      <div
        id="filterMobile"
      ...
      >
        <div id="prefrencesFilterdiv" type="div" className="bg-indigo-600 text-white py-2 px-4 rounded-lg mb-5">
          Apply Preferences Filter
        </div>
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center font-bold">
            <div>Filters</div>
            <div className="ml-2 bg-blue-500 text-white py-2 px-4 rounded-lg hidden lg:block">
              Apply Filter
            </div>
          </div>
          <div className="flex space-x-2">
            ...
            <div className="ClearFilterdiv lg:hidden" onClick={closeFilter} id="hide-filter">
        ...
        <div className="mt-4">
          ...
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="mr:1,sales:1" />
        ...
        <div className="mt-4">
          ...
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="mr:1,price:1,ppr_max:50" />
            <label className="form-check-label" htmlFor="mr:1,price:1,ppr_max:50">
              Up to $50
            </label>
          </div>
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="mr:1,price:1,ppr_min:50,ppr_max:100" />
            <label className="form-check-label" htmlFor="mr:1,price:1,ppr_min:50,ppr_max:100">
              $50 – $100
            </label>
          </div>
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="mr:1,price:1,ppr_min:100,ppr_max:250" />
            <label className="form-check-label" htmlFor="mr:1,price:1,ppr_min:100,ppr_max:250">
              $100 – $250
            </label>
          </div>
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="mr:1,merchagg:g8299768%7Cm117089458%7Cm117079928" />
        ...
        <div className="mt-5">
          <div id="filterdivs" type="div" className="bg-blue-500 text-white py-2 px-4 rounded-lg">
            Apply Filter
          </div>
        </div>
      </div>
